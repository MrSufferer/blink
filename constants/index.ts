...
export const web3AuthClientId =
    process.env.NEXT_PUBLIC_WEB3AUTH_CLIENT_ID || "BE9e55S0iDLaJnhneW1jz1LV4K4YDzngnyLxZz4IlsrqBLy-nuR-VokYILuXY1i7pdTi6isKN6CKchap7kvrB-k";
export const productName = "Plink";
